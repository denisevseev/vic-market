  ...
  return (
    <Box className="container mt-6rem mb-3-rem ta-center">
      ...
      <h3 className="terms-subtitle">
        ...
        email: vcd@victorum.com, helpdesk@victorum.com)
      </h3>
      <Box
        sx={{
          borderBottom: 1,
      ...
      <TabPanel value={value} index={1}>
        ...
        <p className="terms-description">
          ...
          User or Rs. 10,000/- (Indian Rupees Ten Thousand)
        </p>
      ...
      <TabPanel value={value} index={2}>
        ...
        <div className="fraud-box">
          <p className="terms-description">
            ...
            with individuals, body corporates or companies from any part of the
            world.
          </p>
          <p className="terms-description">
            b. Users are advised to exercise due caution while transacting with
            a prospective buyer or a seller on the Site. Users must undertake
            ...
            undertaking thorough diligence on such organization and/or
            individual. Neither the Company nor its director’s, employees,
            officers or agents shall be liable to any User or otherwise for any
            illegal or fraudulent interaction or transaction with organizations
            and/or individuals located on or through the Site.
          </p>
          ...
          <p className="terms-description">
            d. Users are advised not to transact business unless full payment is
            made to you before shipping of the products.
          </p>
        </div>

        <p className="terms-description">
          a. <b>CREDIT CARD SCAMS</b> When a User receives any online Order paid
          by Credit Card, it is recommended that you ask for a written Credit
          Card Authorisation to be faxed to you. Please get validity of the
          Credit Card checked with your Bank or contact VISA, Master Card or
          American Express directly. Unless the validity of the Credit Card is
          confirmed, please do not ship any goods.
        </p>

        <p className="terms-description">
          b. <b>BANK DRAFT SCAMS - BANK DRAFT SCAMS - </b> There have been cases
          of people receiving Bank Drafts with unauthorised printing of Bank
          Names. Before shipping any product or advancing a partial cash
        ...
        <p className="terms-description">
          ...
          Offers to BUY large quantity of Computers and other material.Once you
          submit your bid; you will be notified that your Tender has been
          accepted. You will then be asked to pay for Legal fees and Tender Fee.
          DO NOT PAY ANY FEE. Dont ship any Computers/Other products unless you
          have the cash in your account confirmed by your bank.
        </p>
