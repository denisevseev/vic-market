...
export default function SuccessfullSellerPage() {
  const handleContact = () => {
    window.location.href = "mailto:" + globalDetails.email;
  };

  const [sectiontitle, setSectionTitle] = useState<string>("Are you a Successful Seller?");
          ...
          <Box className="pressTitleHeadlineMWLogo">
            ...
            >
              ...
              <Box className="pressTitleBg">
                ...
                Become successful seller
                </Typography>
              </Box>
              {/* HEADLINE */}
              <Typography className="pressTitle">
                Learn how to maximize your profits on Victorum Trade!
              </Typography>
            </Box>
