...
export default function PrivacyPolicyPage() {
  ...
  return (
    <>
    <HeadData title={"Privacy Policy | Victorum Marketplace"} />
        ...
        <TabPanel value={value} index={0}>
          <div className="defined-terms-section ta-start">
            <p className="terms-description">
              ...
              YOUR USE OF OUR WEBSITE. BY USING OUR WEBSITE AND OUR SERVICE YOUR
              USE OF THE WEBSITE SIGNIFIES YOUR ACCEPTANCE OF THESE TERMS OF USE
              AND AGREEMENT TO BE BOUND BY THEM AND ANY AND ALL OTHER APPLICABLE
            ...
            <p className="terms-description">
              ...
              alter the presentation, substance, or functionality of the
              Website.
            </p>
            ...
            <p className="terms-description">
              ...
              Exhibitor Online Application Service is also subject to our Terms
              of Application and Exhibition Rules & Regulations In the event of
              any conflict, the specific Services terms and conditions shall
            ...
            <p className="terms-description">
              ...
              data areas for which you have not been authorised by us; restrict
            ...
            <p className="terms-description">
              ...
              offensive, or otherwise objectionable or unreasonable Information
            ...
            <p className="terms-description">
              ...
              marketing activities and/or disseminating or circulating any part
              of the content of any unsolicited publicity or advertising
              materials; advertising and/or promoting any goods and services;
              sale or exchange of any part of the Information obtained through
              the Website for any benefits, gain, profit or rewards;
            </p>

            <p className="terms-description">
              or any other commercial purposes; and/or upload, post, publish,
              transmit, reproduce, or distribute in any way, Information
              obtained through the Website which is protected by copyright, or
              other proprietary right, or create derivative works with respect
              thereto, without the prior written permission of the copyright
              owner or rightholder. You have no rights in or to the Information
              available from time to time on the Website and you will not use
              the Information available from time to time on the Website in any
              manner or for any purpose, except as permitted under these Terms
              of Use.
            </p>
            ...
            <p className="terms-description">
              ...
              to the Website or any part thereof immediately and without notice,
              where we are of the opinion that you have breached any of the
              terms contained in the Terms of Use or that such prohibition or
              denial is appropriate, desirable or necessary in our sole
              discretion.
            </p>
            ...
            <h3 className="terms-description">
              ...
              further details), you must keep your log-in details (if any)
              confidential and ensure that only you or your authorized employees
              access the Services for proper purposes.
            </h3>
            ...
            <p className="terms-description">
              ...
              Providers or sourced by HKTDC from other references or sources.
              The Information on the Website may not be regarded as any
              recommendation or endorsement by HKTDC for any purpose with
              respect to any person, product or service.
            </p>

            <p className="terms-description">
              HKTDC is not responsible if any such Information is not
              up-to-date; HKTDC does not separately verify such Information.
              Accordingly we do not accept any responsibility whatsoever in
              respect of such Information. Any use of and reliance on such
            ...
            <p className="terms-description">
              Links to other websites do not constitute an endorsement by HKTDC
              of such websites or the Information, products, advertising or
              other materials available on those websites.
            </p>
            ...
            <p className="terms-description">
              ...
              any purpose whatsoever (whether or not constituting a breach of
              any provision in these Terms of Use). We may, if necessary,
              participate in the defence of any claim or action and any
              ...
              notice to you, to assume exclusive defence and control of any
              claim or action.
            </p>
            ...
            <p className="terms-description">
              ...
              Website belong to HKTDC or have been lawfully licensed to HKTDC
              for use on the Website. All rights under applicable laws are
              hereby reserved. Except with the express permission of HKTDC, you
              are not allowed to upload, post, publish, reproduce, transmit or
              distribute in any way any component of the Website itself or
              create derivative works with respect thereto, as the Website is
              copyrighted under applicable laws.
            </p>
            ...
            <p className="terms-description">
              messages sent through the internet including in connection with
              the Services will be free from interception, corruption, error,
              delay or loss;
            </p>
            ...
            <p className="terms-description">
              ...
              profit, arising out of any use, or inability to use, the
              Information or the Services, even if HKTDC or the HKTDC Affiliates
            ...
            <p className="terms-description">
              ...
              personal data is collected in connection with the Services, you
              should also have reference to the relevant user agreements linked
              to the form through which your personal data is collected.
            </p>
            ...
            <p className="terms-description">
              ...
              notice to you and without cause, terminate all or any part of our
              Services to you and consequentially prohibit your right to access
              to the Services and/or the Website and remove any information and
              data linked to your profile or registered account.
            </p>
            ...
            <h3 className="terms-subtitle">
              USER AGREEMENT RESEARCH SERVICES{" "}
            </h3>
            ...
            <p className="terms-description">
              ...
              (referred to as “Website”, Site, “Platform”, “App” and
              “Channels”).
            </p>

            <p className="terms-description">
              We truly respect your privacy and we promise always to implement
              the latest technologies to protect the security and
              confidentiality of the personal data which are transmitted to us.
            </p>

            <p className="terms-description">
              Further we are always trying to limit the personal data collected
              and stored to the minimum required to provide our online and
              offline services.
            </p>
            ...
            <p className="terms-description">
              In order to provide a better service to our visitors and clients,
              we may, in the course of and in relation to provision of our
              services or products, collect and process the following
              information about:
            </p>
            ...
            <p className="terms-description">
              ...
              attend our functions, or communicate with us. In some
              circumstances, we may also collect personal identification data
              such as your passport or identity card number, date of birth
              and/or nationality for security and verification purposes;
            </p>
            ...
            <p className="terms-description">
              ...
              to provide you with the requested services and for us to perform
              our contractual obligations if any to you In case you do not
              supply such data or you supply such data incompletely we may be
              unable to provide the requested services
            </p>

            <p className="terms-description">
              Please keep in mind, when you browse the Site, we will collect the
              basic technical information that your browser sends to the Site
              such as
            </p>
            ...
            <p className="terms-description">
              <b>d.</b> your Internet Protocol (IP) address, or click stream
              data within our website (i.e. the actions taken in connection with
              the Site) etc.
            </p>
            ...
            <p className="terms-description">
              ...
              online platforms through our automatic data collection tools,
              which may include cookies (please read the section about the usage
              of cookies below carefully) and other commonly used online
              technologies.
            </p>
            ...
            <p className="terms-description">
              ...
              purchase and sales of products, goods and raw materials,
              forwarding of buy and sell requests, exchange of buy and sell
              orders and introduction of buy/sell parties to each other
            </p>
            ...
            <p className="terms-description">
              ...
              and international trade fairs, promotional events and similar
              events related to trade fairs
            </p>
            ...
            <p className="terms-description">
              ...
              business partners and counterparts engaged in similar or
              peripheral activities, such as business matching services,
              sourcing, client introduction and market analysis
            </p>
            ...
            <p className="terms-description">
              ...
              corporate details, certificates of incorporation, etc.) will be
              used solely for the purposes described in these guidelines.
            </p>
            ...
            <h3 className="terms-subtitle">
              ...
              provide your personal data to:{" "}
            </h3>

            <p className="terms-description">
              <b>a.</b> personnel, agents, advisers, auditors, contractors,
              financial institutions, and service providers in connection with
            ...
            <p className="terms-description">
              We may provide your personal data as required or permitted by law
              to comply with a summons, subpoena or similar legal process or
              government request, or when we believe in good faith that
              ...
              judicial and regulatory authorities in or outside Hong Kong.
            </p>

            <p className="terms-description">
              We may also transfer your personal data to a third party that
              acquires all or part of our assets or shares, or that succeeds us
              in carrying on all or a part of our business, whether by merger,
              acquisition, reorganization or otherwise.
            </p>

            <p className="terms-description">
              To prevent and detect crimes and to protect the security and
              safety of our events and activities, we may provide your personal
            ...
            <p className="terms-description">
              ...
              (or other device) when you access our website.
            </p>

            <p className="terms-description">How do we use cookies?</p>

            <p className="terms-description">
              We use cookies to improve your experience of our website and
            ...
            <p className="terms-description">
              <b>-</b> Providing more effective and relevant advertising based
              on your interests
            </p>
            ...
            <p className="terms-description">
              ...
              drive, block the use of cookies and/or be notified when cookies
              are encountered. If you elect to block cookies, please note that
              you may not be able to take full advantage of the features and
              functions of our online platforms and/or apps.
            </p>

            <p className="terms-description">
              We use www.mailchimp.com as an email delivery and marketing
              company to send emails and newsletters that you have subscribed to
              or agreed to receive. Pixels, tags and cookies are used in those
              messages and at our Site to help us measure the effectiveness of
              our advertising and how visitors use our web site and read our
              messages.
            </p>
            ...
            <p className="terms-description">
              ...
              information used by this company, please refer to the cookie
              policy of the respective company directly.
            </p>

            <h3 className="terms-subtitle">
              6. Hyperlinks & External Websites{" "}
            </h3>

            <p className="terms-description">
              Our website contains links to the websites of third parties. As
              the content of these websites is not under our control, we cannot
              assume any liability for such external content. In all cases, the
              provider of information of the linked websites is liable for the
              content and accuracy of the information provided.
            </p>

            <p className="terms-description">
              At the point in time when the links were placed, no infringements
              of the law were recognizable to us. As soon as an infringement of
              the law becomes known to us, we will immediately remove the link
              in question.
            </p>
            ...
            <p className="terms-description">
              We may update this Privacy Policy from time to time. Once we do
              so, the updates will be posted in the news section of our website
              and/or our social media accounts.
            </p>

            <p className="terms-description">
              In case of any questions please do not hesitate to get in touch
              with us. Please dial +852 4610 489 - 0 Extension: 165 or send us a
            ...
            <p className="terms-description">
              We will generally hold your data on our servers hosted in Hong
              Kong. However, we may transfer it to our overseas offices
              elsewhere in the world for the purpose of processing your
              personal, company and product details into our database and to
              forward them to potential customers of your products and services.
            </p>

            <p className="terms-description">
              In case you and/or your company are located in the European
              Economic Area (“EEA”) your personal data may be transferred to
              countries located outside the EEA which do not provide a similar
              or adequate level of protection to that provided by countries in
              the EEA.
            </p>

            <p className="terms-description">
              Such data transfers will only be made in accordance with
              applicable laws including where necessary for us to comply with
            ...
            <p className="terms-description">
              ...
              application on our digital platforms, you acknowledge the
              collection and use of your personal data by us as outlined in this
              Policy.
            </p>
            ...
            <p className="terms-description">
              ...
              Conditions or Terms of Use, please leave our websites and do not
              use our apps or other digital platforms or services.
            </p>

            <p className="terms-description">
              Under the Hong Kong Personal Data (Privacy) Ordinance, you have
              the right:
            </p>
            ...
            <p className="terms-description">
              ...
              State, subject to certain limitations and/or restrictions, you
              have the right under the data protection laws in the EU:
            </p>
            ...
            <p className="terms-description">
              Individuals located in the EU additionally have the right to lodge
              a complaint about the processing of their personal data with their
              local data protection authority.
            </p>

            <h3 className="terms-subtitle">
              10. Contact Details & Directions{" "}
            </h3>

            <p className="terms-description">
              We are there for you in case of any questions related to privacy
              or data storage. If you wish to exercise one of the above
              mentioned rights, cease marketing communications, and/or raise
              questions or complaints, please feel free to contact us at any
              time.
            </p>
            ...
            <p className="terms-description">
              Email: privacy@victorum-group.com
            </p>
          </div>
        </TabPanel>
      </Box>
