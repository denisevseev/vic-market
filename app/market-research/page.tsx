        ...
        <Box className="marketResearchTitleHeadlineMW">
          ...
          >
            ...
            <Typography className="marketResearchTitle">
              Do you want to expand into South America, China, India, Africa or
              Eastern Europe?
            </Typography>
          </Box>
          <Box
      ...
      <Box className="marketResearchTextContainerPadding">
        <Box className="marketResearchtextContainer">
          <Typography className="marketResearchSubtitle">
            For companies, tapping into international markets is an obvious step
            and many companies and retailers actually earn a not inconsiderable
            proportion of their turnover outside their own home country.
          </Typography>
          <Typography className="marketResearchSubtitle">
            But beware, the enormous growth opportunities are often accompanied
            by underestimated risks.
          </Typography>
          <Typography className="marketResearchSubtitle">
            It is precisely these risks that we can eliminate together with you
            with our research services
          </Typography>
          <Typography className="marketResearchSubtitle">
            Many markets are lucrative, but there are always national and local
            regulations and trade agreements to consider. In addition, the
            structure and preferences of consumers differ in different countries
            and regions. However, if these are not carefully considered in
            advance, product sales can quickly come to a standstill.
          </Typography>
          <Typography className="marketResearchSubtitle">
            It is therefore important to work with an experienced service
            provider who can support the company in its internationalisation as
            early as the planning phase of an expansion.
          </Typography>
          <Typography className="marketResearchSubtitle">
